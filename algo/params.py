...
class Parameters:
    ...
    TS_delta: float= 0.7
    threshold_T: float = math.sqrt(70000 / math.pi) * 2  # assumption 7ha, based on radios sqrt(7ha / pi). Radius is unrealistic, hence multiply with 1.5, which is about 298.54
